...
- 다음 작업은 현재 route, transit, stock, price 관찰을 넘어 richer downstream-economy scoring으로 가는 것이다
...
1. route, transit, stock, price 관찰 이후를 보는 deeper downstream-economy monkey scoring으로 확장한다
