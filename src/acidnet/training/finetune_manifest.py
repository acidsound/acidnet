...
def _dataset_spec(train_rows_target: int, eval_rows_target: int) -> DatasetSpec:
    return DatasetSpec(
        train_rows_target=train_rows_target,
        eval_rows_target=eval_rows_target,
        prompt_format="bootstrap_teacher_prompt_pack_v1",
        train_jsonl_path="data/prompt_packs/bootstrap_teacher_requests.jsonl",
        train_parquet_path="data/prompt_packs/bootstrap_teacher_requests.parquet",
        eval_jsonl_path="data/prompt_packs/bootstrap_teacher_requests.jsonl",
        eval_parquet_path="data/prompt_packs/bootstrap_teacher_requests.parquet",
        merged_sft_jsonl_path="data/sft/bootstrap_teacher_sft_dataset.jsonl",
        merged_sft_parquet_path="data/sft/bootstrap_teacher_sft_dataset.parquet",
        train_sft_jsonl_path="data/sft/train_bootstrap_teacher_sft_dataset.jsonl",
        train_sft_parquet_path="data/sft/train_bootstrap_teacher_sft_dataset.parquet",
        eval_sft_jsonl_path="data/sft/eval_bootstrap_teacher_sft_dataset.jsonl",
        eval_sft_parquet_path="data/sft/eval_bootstrap_teacher_sft_dataset.parquet",
