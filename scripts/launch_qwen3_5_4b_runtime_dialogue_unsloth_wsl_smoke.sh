...
RUN_NAME="qwen3_5_4b_runtime_dialogue_unsloth_wsl_smoke${ACIDNET_WSL_RUN_SUFFIX:-}"
TRAIN_DATASET="${ACIDNET_WSL_TRAIN_DATASET:-data/sft/bench_train_1024.jsonl}"
EVAL_DATASET="${ACIDNET_WSL_EVAL_DATASET:-data/sft/bench_eval_128.jsonl}"
