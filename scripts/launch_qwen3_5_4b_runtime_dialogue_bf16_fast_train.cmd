...
set "LOG_PATH=data\logs\qwen3_5_4b_runtime_dialogue_full_train_bf16_fast.log"

echo [%date% %time%] Starting bf16 fast runtime-dialogue training... > "%LOG_PATH%"
python run_qwen4b_baseline_train.py ^
  ...
  --output-dir data/training/qwen3_5_4b_runtime_dialogue_full_adapter_bf16_fast ^
