...
RUN_NAME="qwen3_5_4b_runtime_dialogue_unsloth_wsl_promptrefresh_foodfix_smoke${ACIDNET_WSL_RUN_SUFFIX:-}"
TRAIN_DATASET="${ACIDNET_WSL_TRAIN_DATASET:-data/test_artifacts/train_runtime_dialogue_promptrefresh_smoke_2048.jsonl}"
EVAL_DATASET="${ACIDNET_WSL_EVAL_DATASET:-data/test_artifacts/eval_runtime_dialogue_promptrefresh_smoke_256.jsonl}"
